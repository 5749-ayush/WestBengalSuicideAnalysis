...
2) Open Suicide_project.R in RStudio or your preferred R environment.

3) Install the required dependencies:

R : install.packages(c("tidyverse", "summarytools"))
4) Run the script to generate the analysis and visualizations.
